...
namespace Drawing {
    ...
    public class ScreenPixelManage {
        ...
        public ScreenPixelManage(Graphics graphics, ComplexPoint screenBottomLeftCorner, ComplexPoint screenTopRightCorner) {
            ...
            convConstX1 = graphics.VisibleClipBounds.Size.Width / (screenTopRightCorner.real - screenBottomLeftCorner.real);
            convConstX2 = convConstX1 * screenBottomLeftCorner.real;

            convConstY1 = graphics.VisibleClipBounds.Size.Height * (1.0 + screenBottomLeftCorner.img / (screenTopRightCorner.img - screenBottomLeftCorner.img));
            convConstY2 = graphics.VisibleClipBounds.Size.Height / (screenTopRightCorner.img - screenBottomLeftCorner.img);
        }
        ...
        public PixelCoord GetPixelCoord(ComplexPoint cmplxPoint) {
            ...
            result.xPixel = (int) (convConstX1 * cmplxPoint.real - convConstX2);
            result.yPixel = (int) (convConstY1 - convConstY2 * cmplxPoint.img);
            return result;
        }
        ...
        public ComplexPoint GetDeltaMathsCoord(ComplexPoint pixelCoord) {
            ComplexPoint result = new ComplexPoint(
                   pixelCoord.real / convConstX1,
                   pixelCoord.img / convConstY2);
            return result;
        }
        ...
        public ComplexPoint GetAbsoluteMathsCoord(ComplexPoint pixelCoord) {
            ComplexPoint result = new ComplexPoint(
                   (convConstX2 + pixelCoord.real) / convConstX1,
                   (convConstY1 - pixelCoord.img) / convConstY2);
            return result;
        }
    }
}
